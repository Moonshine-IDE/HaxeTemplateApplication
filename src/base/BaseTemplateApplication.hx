...
import base.source.views.containers.CrashNotification;
import base.source.haxeScripts.updater.ApplicationUpdateManager;
...
abstract class BaseTemplateApplication extends feathers.controls.Application
{
    ...
    public function new()
    {
        ...
        ExceptionListener.onException.add(this.onHaxeException);
